...
contract Blood{
    ...
    address payable public admin = address(0x4B1CCffde7B477537E4DE2Bb4Ee52495b215A6ef);
    address payable public hospi = address(0x0c7eD5d8400d8Ec302Ce4cEf1Bca3baA8C0059E3);
    ...
    constructor() public{
        name = "Chinmay Dharap";
        userCount ++;
        usertype[admin] = User(userCount, 14, "Admin", admin, "Chinmay", '123456', 'A', "Mumbai");
        users[userCount] = User(userCount, 14, "Admin", admin, "Chinmay", '123456', 'A', "Mumbai");
    }
