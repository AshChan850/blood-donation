...
class Donor extends Component {  
  render() {
    return (
      ...
      <br></br>
        <h1 className="head">Welcome <strong>{this.props.usertype[this.props.account].name}</strong></h1><br></br>
        <h3 className="text-center">Here you can check the blood bag status which you donated!!</h3><br></br>
        <div>
            <button
